...
export class SadScene extends Phaser.Scene { // cria uma cena chamada EndScene

    alturaJogo = config.height; // define a altura do jogo
    larguraJogo = config.width; // define a largura do jogo

    constructor() {
        super("SadScene"); // registra o nome da cena
    }


    preload() {
        this.load.image("Sadbg", "./assets/preso.jpg") // carrega o fundo da cena
    }

    create() {
        this.add.image(this.larguraJogo/2, this.alturaJogo/2, "Sadbg");
